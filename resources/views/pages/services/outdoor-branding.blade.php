...
@section('content')
	...
	<section id=main_content class=container>
		<article
			...
			<p>
				Outdoor branding refers to the use of advertising and visual marketing materials in open or outdoor spaces to promote a company, product, or service to the public. 
				<br>
				It aims to create strong visibility and brand awareness among people as they move through public areas.
            </p>
