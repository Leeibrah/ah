...
@section('content')
	...
	<section id=main_content class=container>
		<article
			...
			<p>
                A roll-up banner is a self-standing printed display that rolls into a metal or plastic base for easy setup, transport, and storage — commonly used to showcase products, promotions, or brand messages.
            </p>
