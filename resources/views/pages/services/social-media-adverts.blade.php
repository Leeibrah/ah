...
@section('content')
	...
	<section id=main_content class=container>
		<article
			...
			<p>
				Social media adverts (or social media advertisements) are paid promotional messages that appear on social media platforms like Facebook, Instagram, X (Twitter), TikTok, LinkedIn, or YouTube.
				<br>
				They’re designed to reach a specific audience based on demographics, interests, or behavior — with the goal of increasing brand awareness, driving traffic, or boosting sales.
            </p>
