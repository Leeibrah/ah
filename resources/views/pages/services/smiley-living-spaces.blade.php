...
@section('content')
	...
	<section id=main_content class=container>
		<article
			...
			<p>
                Smiley Living Spaces is a concept that focuses on creating positive, comfortable, and emotionally uplifting environments where people feel relaxed, happy, and connected. 
                <br>
                It emphasizes design, color, lighting, and layout that enhance mood, promote well-being, and encourage joyful living.
            </p>
